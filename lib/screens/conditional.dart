...
class Conditional extends StatefulWidget {
  ...
  const Conditional({Key? key,required this.leverage , required this.pair,required this.isolated_cross}) : super(key: key);


  @override
  State<Conditional> createState() => new _ConditionalState(leverage,pair,isolated_cross);
}
...
class _ConditionalState extends State<Conditional> {
  ...
  _ConditionalState(this.leverage,this.pair,this.isolated_cross);
  /*----------------------------------------------------------------------*/
        ...
        Row(
          children: [
            ...
            InkWell(
              ...
              child: Icon(
                  Icons.add_box, color: Colors.blue,
                  size: 20),
            ),
          ],
        ),
          ...
          children: [
            ...
            Container(
              ...
              child: ElevatedButton(
                ...
                onPressed: () async {
                  print(widget.leverage);
                  print(widget.pair);
                  print(widget.isolated_cross);
                }
